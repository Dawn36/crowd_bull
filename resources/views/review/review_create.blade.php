                ...
                <div class="row gy-5 g-xl-10">
                    <div class="col-xl-12 mb-5 mb-xl-10">
                        <form id="" class="form d-flex flex-column flex-lg-row" method="POST"
                            action="{{ route('re-view.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body text-center pt-0">
                                        ...
                                        <div class="text-muted fs-7">Set the Review main image. Only *.png, *.jpg and
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="review_name" class="form-control mb-2"
                                                            placeholder="Review name" value="" required />
                                                        <div class="text-muted fs-7">Review name is required and
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-muted fs-7">Set a description to the Review
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <div class="text-muted fs-7">Meta Title is required for SEO
                                                        </div>
                                                    </div>
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <textarea name="meta_description" class="form-control" cols="30" rows="3" placeholder="Meta Description"
                                                            required></textarea>
                                                        <div class="text-muted fs-7">Meta Description is required for
                                                            SEO</div>
                                                    </div>
                                                    <div class="mb-10 fv-row">
