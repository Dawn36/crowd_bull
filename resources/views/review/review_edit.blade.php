                ...
                <div class="row gy-5 g-xl-10">
                    <div class="col-xl-12 mb-5 mb-xl-10">
                        <form id="" class="form d-flex flex-column flex-lg-row" method="POST"
                            action="{{ route('re-view.update', $review->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body text-center pt-0">
                                        <div class="image-input image-input-empty image-input-outline mb-3"
                                            ...
                                            style="background-image: url('{{ asset($review->review_thumbnail) }}')">
                                        ...
                                        <div class="text-muted fs-7">Set the Review main image. Only *.png, *.jpg and *.jpeg
                            ...
                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                <ul
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                                            href="#kt_add_review_general">General</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-active-primary pb-4 " data-bs-toggle="tab"
                                            href="#kt_add_review_meta_data">Meta Fields</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <!-- General -->
                                    <div class="tab-pane fade show active" id="kt_add_review_general" role="tab-panel"
                                        style="width: 757px;">
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="review_name" class="form-control mb-2"
                                                            placeholder="review name" value="{{ $review->review_name }}"
                                                            required />
                                                        <div class="text-muted fs-7">Review name is required and recommended
                                                            to be unique.</div>
                                                    </div>
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <textarea name="i_frame_link" class="form-control" cols="30" rows="3"
                                                            placeholder="Youtube/ SoundCloud iFrame Link">{{ $review->i_frame_link }}</textarea>
                                    ...
                                    {{ $review->description }}
                                                        ...
                                                        <div class="text-muted fs-7">Set a description to the Review for
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="meta_title" class="form-control mb-2"
                                                            placeholder="Meta Title" value="{{ $review->meta_title }}"
                                                            required />
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <textarea name="meta_description" class="form-control" cols="30" rows="3" placeholder="Meta Description"
                                                            required>{{ $review->meta_description }}</textarea>
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="meta_keywords"
                                                            ...
                                                            value="{{ $review->meta_keywords }}" required />
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="{{ route('re-view.index') }}" class="btn btn-light-dark me-3">Discard</a>
