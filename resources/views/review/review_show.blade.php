                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">Review: <span class="text-primary text-decoration-underline">{{ucwords($review->review_name)}}</span></a>
                                    </div>
                                ...
                                <div class="d-flex my-4">
                                    <button class="btn btn-sm btn-circle btn-primary me-2" onclick="editReview('{{ $review->id}}')">Edit Review</a>
                                </div>
                            </div>
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="fs-6 fw-bolder">{{ Date("Y-m-d",strtotime($review->created_at))}}</div>
                                            </div>
                            ...
                            <div class="mb-17">
                                <div class="mb-8">
                                    ...
                                    <div class="overlay mt-8">
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px" style="background-image:url('{{asset($review->review_thumbnail)}}')"></div>
                                    </div>
