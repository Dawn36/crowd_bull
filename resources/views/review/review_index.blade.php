                        ...
                        <div class="card card-docs mb-2">
                            <div class="p-10">
                                ...
                                <div class="d-flex align-items-center rounded py-5 px-4 bg-light-primary">
                                    ...
                                    <div class="text-gray-700 fw-bold fs-6 lh-lg">Here is the list of all of the Review that
                                        we have.</div>
                                </div>
                            </div>
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        <a href="{{ route('re-view.create') }}" class="btn btn-primary me-2">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            @for ($i = 0; $i < count($review); $i++)
                                                ...
                                                <tr>
                                                    <td>{{ $a }}</td>
                                                    <td>
                                                        <a href="{{ route('re-view.show', $review[$i]->id) }}"
                                                            class="fw-bolder text-hover-primary">{{ ucwords($review[$i]->review_name) }}</a>
                                                    </td>

                                                    <td>
                                                        <div class="badge badge-light-success text-success">Active</div>
                                                    </td>
                                                    <td>{{ ucwords($review[$i]->first_name) }}
                                                        {{ ucwords($review[$i]->last_name) }}</td>
                                                    <td>{{ Date('Y-m-d', strtotime($review[$i]->created_at)) }}</td>
                                                    <td>
                                                        <a href="{{ route('re-view.edit', $review[$i]->id) }}"
                                                            class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2"
                                                            data-bs-original-title="Edit Review">
                                                            <span class="svg-icon svg-icon-2">
