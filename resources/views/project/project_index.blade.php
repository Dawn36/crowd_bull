                    ...
                    <div class="card card-docs mb-2">
                        <div class="p-10">
                            ...
                            <h1 class="anchor fw-bolder mb-5" id="zero-configuration">
                                <a href="javascript:;"></a>Projects Listing
                            </h1>
                            <!--begin::Notice-->
                        ...
                        <div class="card-header border-0">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary me-2" onclick="addProject()">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex flex-column w-100">
                                                    ...
                                                    <div class="progress h-5px w-100">
                                                        <div class="progress-bar bg-primary" role="progressbar" style="width: {{$project[$i]->funding_progress}}%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                                 </td>
                                            ...
                                            <td>
                                                ...
                                                <form  style="display: inline-block" method="POST" action="{{ route('projects.destroy', $project[$i]->id) }}">
                                                    @method('DELETE')
                                                    @csrf
...
<script type="text/javascript">
    function addProject() {
        $.ajax({
            ...
            success: function(result) {
                $('#myModalLgHeading').html('Add Projects');
    ...
    function eidtProjects(id) {
        ...
        $.ajax({
            ...
            url: url,
            success: function(result) {
                $('#myModalLgHeading').html('Edit Projects');
                $('#modalBodyLarge').html(result);
                $('#myModalLg').modal('show');
            }
        });
