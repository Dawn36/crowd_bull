<form id="" class="form" method="POST" action="{{ route('projects.store') }}" enctype="multipart/form-data">
    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="goal" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Goal here." required />
        </div>
        <div class="fv-row mb-7">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="interest" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Interest here." required/>
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">LTV</label>
            <input type="text" name="ltv" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your LTV here." required/>
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Raised to date</label>
            <input type="text" name="raised_to_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Raised to date here." required/>
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Funding progress</label>
            <input type="text" name="funding_progress" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Funding progress here." required/>
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2"># of Investors</label>
            <input type="text" name="investors" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your # of Investors here." required/>
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Average Ticket</label>
            <input type="text" name="avg_ticket" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Average Ticket here."required />
        </div>
        <div class="fv-row mb-7">
