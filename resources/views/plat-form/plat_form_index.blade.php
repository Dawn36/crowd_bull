                                    ...
                                    <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            @for ($i = 0; $i < count($platForm); $i++)
                                                ...
                                                @endphp
                                                <tr>
                                                    <td><a href="{{ route('plat_form.show', $platForm[$i]->id) }}"
                                                            class="fw-bolder text-gray-800 text-hover-primary mb-1">{{ $a }}</a>
                                                    </td>
                                                    <td><a href="{{ route('plat_form.show', $platForm[$i]->id) }}"
                                                            class="fw-bolder text-gray-800 text-hover-primary mb-1">{{ ucwords($platForm[$i]->plat_form) }}</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <button
                                                            ...
                                                            onclick="editPlatForm('{{ $platForm[$i]->id }}')">
                                                        ...
                                                        <form style="display: inline-block" method="POST"
                                                            action="{{ route('plat_form.destroy', $platForm[$i]->id) }}">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button type="submit"
