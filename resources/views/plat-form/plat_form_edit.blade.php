<form id="" class="form" method="POST" action="{{ route('plat_form.update', $platForm->id) }}"
    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true"
        ...
        <div class="fv-row mb-7">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true"
                style="background-image: url('{{ asset($platForm->plat_form_image) }}')">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="plat_form" value="{{ $platForm->plat_form }}"
                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your Platform here."
                required />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Capital raised to date</label>
            <input type="number" name="capital_raised_to_date" value="{{ $platForm->capital_raised_to_date }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Capital raised to date here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Avg Interest Rate</label>
            <input type="text" name="avg_interest_rate" value="{{ $platForm->avg_interest_rate }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Avg Interest Rate here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2"># of projects funded</label>
            <input type="number" name="no_of_project_funded" value="{{ $platForm->no_of_project_funded }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your # of projects funded here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2"># of projects not funded</label>
            <input type="number" name="no_of_project_not_funded" value="{{ $platForm->no_of_project_not_funded }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your # of projects not funded here." />
        </div>
        {{-- <div class="fv-row mb-7">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="number" name="no_of_investors" value="{{ $platForm->no_of_investors }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your # of Investors here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Avg. ticket size</label>
            <input type="number" name="avg_ticket_size" value="{{ $platForm->avg_ticket_size }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Avg. ticket size here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Raised in the past 30 days</label>
            <input type="number" name="raised_in_past_30_days" value="{{ $platForm->raised_in_past_30_days }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Raised in the past 30 days here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Raised This Week</label>
            <input type="number" name="raised_in_past_7_days" value="{{ $platForm->raised_in_past_7_days }}"
                class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Raised This Week here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Raised in the past 30 days Percentage</label>
            <input type="text" name="raised_in_the_past_30_days_percentage"
                value="{{ $platForm->raised_in_the_past_30_days_percentage }}"
                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter percentage here." />
        </div>
        <label class="form-label">Raised in the past 30 days Status</label>
        <select class="form-select mb-2" data-control="select2" name="raised_in_the_past_30_days_status"
            data-placeholder="Select an option" data-allow-clear="true">
            <option value="">Select Percentage Status</option>
            <option value="increase"
                {{ $platForm->raised_in_the_past_30_days_status == 'increase' ? 'selected' : '' }}>Increase</option>
            <option value="decrease"
                {{ $platForm->raised_in_the_past_30_days_status == 'decrease' ? 'selected' : '' }}>Decrease</option>
        </select>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Raised this week Percentage</label>
            <input type="text" name="raised_this_week_percentage"
                value="{{ $platForm->raised_this_week_percentage }}"
                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter percentage here." />
        </div>
        <label class="form-label">Raised this week Status</label>
        <select class="form-select mb-2" data-control="select2" name="raised_this_week_status"
            data-placeholder="Select an option" data-allow-clear="true">
            <option value="">Select Percentage Status</option>
            <option value="increase" {{ $platForm->raised_this_week_status == 'increase' ? 'selected' : '' }}>Increase
            </option>
            <option value="decrease" {{ $platForm->raised_this_week_status == 'decrease' ? 'selected' : '' }}>Decrease
            </option>
        </select>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">URL</label>
            <input type="text" name="url" value="{{ $platForm->url }}"
                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter url here." />
        </div>
        <div>
            <label class="form-label">Description</label>
            <textarea hidden name="description" id='description'>{{ $platForm->description }}</textarea>
            <div name="kt_ecommerce_add_product_description" id="kt_docs_quill_basic1"
                class="min-h-200px mb-2 kt_docs_quill_basic1"></div>
