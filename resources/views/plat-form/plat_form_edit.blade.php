<form id="" class="form" method="POST" action="{{ route('plat_form.update',$platForm->id) }}" enctype="multipart/form-data">
    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="raised_in_the_past_30_days_percentage" value="{{$platForm->raised_in_the_past_30_days_percentage}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter percentage here."  />
        </div>
        ...
        <select class="form-select mb-2" data-control="select2" name="raised_in_the_past_30_days_status" data-placeholder="Select an option" data-allow-clear="true" >
            ...
            <option value="increase" {{$platForm->raised_in_the_past_30_days_status == 'increase' ? 'selected' : ''}}>Increase</option>
            <option value="decrease" {{$platForm->raised_in_the_past_30_days_status == 'decrease' ? 'selected' : ''}}>Decrease</option>
        </select>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Raised this week Percentage</label>
            <input type="text" name="raised_this_week_percentage" value="{{$platForm->raised_this_week_percentage}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter percentage here."  />
        </div>
        ...
        <select class="form-select mb-2" data-control="select2" name="raised_this_week_status" data-placeholder="Select an option" data-allow-clear="true" >
            <option value="">Select Percentage Status</option>
            <option value="increase" {{$platForm->raised_this_week_status == 'increase' ? 'selected' : ''}}>Increase</option>
            <option value="decrease" {{$platForm->raised_this_week_status == 'decrease' ? 'selected' : ''}}>Decrease</option>
        </select>
        <div class="fv-row mb-7">
