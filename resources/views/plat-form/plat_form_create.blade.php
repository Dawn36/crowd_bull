<form id="" class="form" method="POST" action="{{ route('plat_form.store') }}" enctype="multipart/form-data">
    @csrf
    <!--begin::Scroll-->
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true"
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="plat_form" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Platform here." required />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Capital raised to date</label>
            <input type="number" name="capital_raised_to_date" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Capital raised to date here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Avg Interest Rate</label>
            <input type="text" name="avg_interest_rate" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Avg Interest Rate here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2"># of projects funded</label>
            <input type="number" name="no_of_project_funded" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your # of projects funded here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2"># of projects not funded</label>
            <input type="number" name="no_of_project_not_funded" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your # of projects not funded here." />
        </div>
        {{-- <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2"># of open projects</label>
            <input type="number" name="no_of_project_open" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter your # of projects here."  />
        </div> --}}
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2"># of Investors</label>
            <input type="number" name="no_of_investors" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your # of Investors here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Avg. ticket size</label>
            <input type="number" name="avg_ticket_size" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Avg. ticket size here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Raised in the past 30 days</label>
            <input type="number" name="raised_in_past_30_days" class="form-control form-control-solid mb-3 mb-lg-0"
                placeholder="Please Enter your Raised in the past 30 days here." />
        </div>
        <div class="fv-row mb-7">
            <label class=" fw-bold fs-6 mb-2">Raised This Week</label>
            <input type="number" name="raised_in_past_7_days" class="form-control form-control-solid mb-3 mb-lg-0"
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="raised_in_the_past_30_days_percentage" value=""
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="raised_this_week_percentage" value=""
                class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter percentage here." />
        </div>
