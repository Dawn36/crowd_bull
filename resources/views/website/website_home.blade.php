                            ...
                            <div class="row align-center ">
                                <div class=" col-md-6 ">
                                    <div class="banner-content   fadeIn fast" data-aos="fade-up" data-aos-duration="1200">
                                        <h2 class=" fc-primary title   slideInLeft">Real estate crowdfunding platforms
                                            tracker.</h2>
                                        <div class="content   slideInUp fast">
                                            <p class="">Tracking real estate crowdfunding platforms to deliver
                                                transparent view and to make data driven investment decisions. </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="tableTabs" style="display:contents;">
                        ...
                        <div class="row">
                            <div class="col">
                                <input name="fastest_funding_pace" id="fastest_funding_pace" value="" disabled
                                    hidden />
                        ...
                        <div class="box blog" style="height: 590px;">
                            ...
                            <div class="content_node">
                                ...
                                <h5 class="fc-black title matchheight">
                                    <a href="{{ route('article', $blog[$i]->slug) }}">
                                        {{ substr(ucwords($blog[$i]->blog_name), 0, 60) }}</a>
                                </h5>
                                <p>
                                ...
                                <div class="profile">
                                    ...
                                    <div class="profile-content">
                                        <h6 class="name">{{ ucwords($blog[$i]->first_name) }}
                                            {{ ucwords($blog[$i]->last_name) }}</h6>
                                        <p class="date">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Crowdfunding is a capital raising process, during which capital is raised from the public via open
                        process. Public entails both private individuals or institutional investors. Usually, crowdfunding
                        is used when other types of capital raising is not possible due to various factors, e.g., risk
                        profile. There might be some cases, when crowdfunding campaigns are being used as a marketing tool
                        to market the product, service or project itself.</p>

                    <h2>What is a real estate crowdfunding?</h2>
                    <p>Real estate crowdfunding is a capital raising process, during which capital for real estate project
                        financing is being raised from the public via open sources. Developers are using real estate
                        crowdfunding process, when bank financing considers this as of a higher risk project and other
                        alternative capital raising sources are not available. A typical element in real estate crowdfunding
                        is real estate pledge as a security for the investors.</p>

                    <h2>What is a real estate crowdfunding platform?</h2>
                    <p>Real estate crowdfunding platform is a middle man between the borrowers and investors. Real estate
                        crowdfunding platform business is a licensed business in EU and regulated by central banks.
                        Therefore, real estate platforms must comply with the central bank requirements, such as: have
                        integral process and procedures how they operate, approved risk scoring models and etc. Platforms
                        themselves also make the borrowing, investing and management process convenient. They ensure that
                        proper documentation is in place, pledges are properly secured, interest payment process is smooth
                        and etc.</p>

                    <h2>What is a real estate crowdfunding project?</h2>
                    <p>Real estate crowdfunding project is real estate development project, for which capital is being
                        raised via real estate crowdfunding platform. Typically, developers of such projects cannot get bank
                        financing, therefore is moving towards more expensive way of raising capital. In exchange for
                        capital, project developer is pledging real estate assets (land or construction).</p>

                    <h2>How to invest in real estate crowdfunding process?</h2>
                    <p>First of all, an investor should select a preferred platform, where he or she wants to invest. A
                        broader description and comparison of various platforms could be found here. Secondly, each
                        regulated platform applies a KYC procedure, which usually contains a self onboarding process with
                        taking a picture of yourself, filling up a questionnaire and supplying additional information.
                        Onboarding process can take from 15min mins to 24 hours depending on the platform and KYC provider
                        platforms are using. After onboarding yourself, you can select the preferred project and invest.
                        Depending from the platform, minimum investments start with as little as 100 EUR.</p>
                </div>
            </div>
        </div>
    </section>
