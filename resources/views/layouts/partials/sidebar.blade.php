    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'crowdestate' ? 'active' : '' }}"
                        href="{{ route('crowdestate') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'estateguru' ? 'active' : '' }}"
                        href="{{ route('estateguru') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'housers' ? 'active' : '' }}"
                        href="{{ route('housers') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M22 12C22 12.9 21.9 13.8 21.7 14.6L5 4.89999C6.8 3.09999 9.3 2 12 2C17.5 2 22 6.5 22 12Z"
                                        fill="currentColor" />
                                    <path opacity="0.3"
                                        d="M3.7 17.5C2.6 15.9 2 14 2 12C2 9.20003 3.1 6.70002 5 4.90002L9.3 7.40002V14.2L3.7 17.5ZM17.2 12L5 19.1C6.8 20.9 9.3 22 12 22C16.6 22 20.5 18.8 21.7 14.6L17.2 12Z"
                                        fill="currentColor" />
                                </svg>
                            </span>
                            <!--end::Svg Icon-->
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'nordstreet' ? 'active' : '' }}"
                        href="{{ route('nordstreet') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'profitus' ? 'active' : '' }}"
                        href="{{ route('profitus') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'rendity' ? 'active' : '' }}"
                        href="{{ route('rendity') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'projects.index' ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'plat_form.index' ? 'active' : '' }}"
                        href="{{ route('plat_form.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'blogs.show' || Route::currentRouteName() == 'blogs.index' || Route::currentRouteName() == 'blogs.create' || Route::currentRouteName() == 'blogs.edit' ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 're-view.show' || Route::currentRouteName() == 're-view.index' || Route::currentRouteName() == 're-view.create' || Route::currentRouteName() == 're-view.edit' ? 'active' : '' }}"
                        href="{{ route('re-view.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Route::currentRouteName() == 'platform_rating.show' || Route::currentRouteName() == 'platform_rating.index' ? 'active' : '' }}"
                        href="{{ route('platform_rating.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
