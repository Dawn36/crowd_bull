                            ...
                            <div class="d-flex align-items-stretch" id="kt_header_nav">
                                <div data-kt-swapper="true"
                                    ...
                                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                                        ...
                                        {{ Route::currentRouteName() == 're-view.show' || Route::currentRouteName() == 're-view.index' ? 'Reviews' : '' }}
                                        {{ Route::currentRouteName() == 're-view.create' ? 'Add Reviews' : '' }}
                                        {{ Route::currentRouteName() == 're-view.edit' ? 'Edit Reviews' : '' }}
                                        {{ Route::currentRouteName() == 'blogs.create' ? 'Add Blog' : '' }}
                                        {{ Route::currentRouteName() == 'blogs.edit' ? 'Edit Blog' : '' }}
                ...
                <div class="modal fade" id="myModalXl" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y p-12" id="modalBodyXl"
