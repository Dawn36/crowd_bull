...
<head>
    ...
    <meta name="description"
        content="Crowdbulls tracks new projects, funding progress, interest rates and overall development of the real estate crowdfunding platforms in scope. Crowdbulls provides comparison both on real estate crowdfunding platforms as well as on projects level.">
    ...
    <div class="mobile-nav" id="nav">
        <div class="mob-nav-logo bg-white ptpx-15 pbpx-15 plpx-15 prpx-15 ">
            <a href="index.php" class="custom-logo-link col-xs-8">
                <img src="{{ asset('theme/website-assets/images/Crowdbull-logo.svg') }}" alt="Crowdbull-logo"
                    class="custom-logo">
            </a>
        </div>
        <nav>
            <div>
                ...
                <ul class="mainnav">
                    ...
                    <li class="menu-item"><a href="{{ route('crowdfunding-platform') }}" class="ss">Platforms</a>
                    </li>
                    <li class="menu-item"><a href="{{ route('crowdfunding-projects') }}" class="ss">Projects</a>
                    </li>
        ...
        <div class="container">
            <div class="row align-center top-header hidden-md-down">
                <div class="col-md-7">
                    ...
                    <ul>
                        <li>
                            Tracked Platforms: <span
                                class="fc-primary">{{ number_format($data['platFormCount']) }}</span>
                        </li>
                        <li>
            ...
            <div class="row align-center">
                ...
                <div class="col-md-8 hidden-md-down">
                    <nav class="pn">
                        <ul class="mainnav">
                            <li class="menu-item {{ Route::currentRouteName() == 'index' ? 'active' : '' }}"><a
                                    href="{{ route('index') }}" class="ss">Home</a></li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'crowdfunding-platform' || Route::currentRouteName() == 'crowdfunding-platforms' ? 'active' : '' }}">
                                <a href="{{ route('crowdfunding-platform') }}" class="ss">Platforms</a></li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'crowdfunding-projects' ? 'active' : '' }}">
                                <a href="{{ route('crowdfunding-projects') }}" class="ss">Projects</a></li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'reviews' || Route::currentRouteName() == 'review' ? 'active' : '' }}">
                                <a href="{{ route('reviews') }}" class="ss">Reviews</a></li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'articles' || Route::currentRouteName() == 'article' ? 'active' : '' }}">
                                <a href="{{ route('articles') }}" class="ss">Articles</a></li>
                            <li
                                class="menu-item {{ Route::currentRouteName() == 'about-us' || Route::currentRouteName() == 'privacy-policy' || Route::currentRouteName() == 'ad-policy' ? 'active' : '' }}">
                                <a href="{{ route('about-us') }}" class="ss">About</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
