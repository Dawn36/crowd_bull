                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body text-center pt-0">
                                        <div class="image-input image-input-empty image-input-outline mb-3"
                                            ...
                                            style="background-image: url('{{ asset($blog->blog_thumbnail) }}')">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="blog_name" class="form-control mb-2"
                                                            placeholder="Blog name" value="{{ $blog->blog_name }}"
                                                            required />
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <textarea name="i_frame_link" class="form-control" cols="30" rows="3"
                                                            placeholder="Youtube/ SoundCloud iFrame Link">{{ $blog->i_frame_link }}</textarea>
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <input type="text" name="meta_keywords"
                                                            ...
                                                            value="{{ $blog->meta_keywords }}" required />
