                        ...
                        <div class="card card-docs mb-2">
                            <div class="p-10">
                                ...
                                <div class="d-flex align-items-center rounded py-5 px-4 bg-light-primary">
                                    ...
                                    <div class="text-gray-700 fw-bold fs-6 lh-lg">Here is the list of all of the Blogs that
                                        we have.</div>
                                </div>
                            </div>
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            @for ($i = 0; $i < count($blog); $i++)
                                                ...
                                                <tr>
                                                    <td>{{ $a }}</td>
                                                    <td>
                                                        <a href="{{ route('blogs.show', $blog[$i]->id) }}"
                                                            class="fw-bolder text-hover-primary">{{ ucwords($blog[$i]->blog_name) }}</a>
                                                    </td>

                                                    <td>
                                                        <div class="badge badge-light-success text-success">Active</div>
                                                    </td>
                                                    <td>{{ ucwords($blog[$i]->first_name) }}
                                                        {{ ucwords($blog[$i]->last_name) }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form style="display: inline-block" method="POST"
                                                            action="{{ route('blogs.destroy', $blog[$i]->id) }}">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button
